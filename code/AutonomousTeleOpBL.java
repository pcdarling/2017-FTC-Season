...
@Autonomous(name="autonomousBottomLeft", group= "TeamBot")
public class AutonomousTeleOpBL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        // Need to get the cryptokey into view, this will affect the goPark function

        //scanKey();
        //telemetry.addData("Algorithm Status:","Reading cryptokey...");
        //telemetry.update();

        // Maybe wait until the key is scanned (or timed out)
    ...
    private void shutdownRobot() {
        ...
        et = new ElevatorThread(robot,STANDARD_ELEVATOR_SPEED,true);
        et.start();
        while (et.isAlive()) {
            // Busy Waiting
        }
